...
using System;
using System.IO;
using static JMERGE.List.CustomField;

namespace JMERGE.List
{
    public class CustomList
    {
        ...
        public void AddCustomField(CustomField.DrawCallbackDelegate drawCallbackDelegate, CustomField.GetHeightCallbackDelegate getHeightCallbackDelegate)
        {
            if (fields == null)
            {
                fields = new List<AbstractField>();
